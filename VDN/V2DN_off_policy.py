...
if __name__ == "__main__":
    ...
    mixer = V2DN_pre(agents,gamma_2,agent_num=robot_num, horizon= batch_size)
    return_list, td_list = rf.train_off_policy_multi_agent(env, mixer,agents, replay_buffers, num_episodes, minimal_size, batch_size,rho,iter)
