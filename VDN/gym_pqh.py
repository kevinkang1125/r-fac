...
class gym_pqh:
    def __init__(self, env_name, mode_name, robot_num, target_model):
        ...
        self.robot_initial_position = 49 if env_name == "MUSEUM" else 53 if env_name == "OFFICE" else None
        ...
        self.target_initial_position = 68 if env_name == "MUSEUM" else 48 if env_name == "OFFICE" else None
        # *********************************************随机3启动************************************************************：
