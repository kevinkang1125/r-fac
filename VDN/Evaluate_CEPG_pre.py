...
class PolicyNet(torch.nn.Module):
    def __init__(self, obs_dim, hidden_dim, action_dim):
        ...
        self.gru = torch.nn.GRU(input_size=obs_dim, hidden_size=hidden_dim, batch_first=True).cuda()
        self.fc1 = torch.nn.Linear(hidden_dim, hidden_dim).cuda()
        self.fc2 = torch.nn.Linear(hidden_dim, action_dim).cuda()
...
class CEPG:
    ...
    def __init__(self, obs_dim, hidden_dim, action_dim, actor_lr, gamma, device, beta):
        ...
        self.actor = PolicyNet(obs_dim, hidden_dim, action_dim).cuda()
