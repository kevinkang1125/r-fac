...
#from RobotLabelDiversity import RobotDiversity
...
if __name__ == "__main__":
    ...
    for i in range(robot_num):
        agent = VPG(state_dim, hidden_dim, action_dim, actor_lr, gamma, device)
        agents.append(agent)
    #diversity_net = RobotDiversity(state_dim, hidden_dim, robot_num, diversity_lr, device)
    diversity_net = 0
